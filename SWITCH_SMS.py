...
print("")
print("\033[91m-𝙼𝙴𝙽𝚄-")
phone = input("\033[91m [ + ]𝙿𝚑𝚘𝚗𝚎 : \033[91m")
jam=int(input("\033[91m [ + ]𝚀𝚞𝚊𝚗𝚝𝚒𝚝𝚢 : \033[91m"))
print("")
print("\033[91m[ ! ]𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙿𝚢𝚃𝚑𝚘𝚗 ")
time.sleep(2)
print("\033[91m[ = ] 𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙿𝚢𝚝𝚑𝚘𝚗 𝟹 ")
time.sleep(2)
print("\033[91m[ = ] 𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙿𝚢𝚝𝚑𝚘𝚗 𝟹 ")
time.sleep(2)
print("\033[91m[ = ] 𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙿𝚢𝚝𝚑𝚘𝚗 𝟹 ")
...
print("\033[91m[ = ] 𝙸𝚗𝚜𝚝𝚊𝚕𝚕 𝙿𝚢𝚝𝚑𝚘𝚗 𝟹 ")
time.sleep(2)
print("\033[91m[ ! ] 𝚁𝚎𝚕𝚊𝚢 𝙵𝚒𝚟𝚎 𝚂𝚎𝚌𝚘𝚗𝚍𝚜 ")
time.sleep(5)
...
for i in range(jam):
    ...
    threading.Thread(target=API_36).start()
    threading.Thread(target=API_37).start()
